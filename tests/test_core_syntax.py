...
class TestScannerParity(unittest.TestCase):
    ...
    def test_worker_on_big_files(self):
        for name in ("editor/text_editor.py", "core/runtime/toggles.py", "core/rendering/render_dispatch.py"):
            path = SRC / name
...
class TestIncremental(unittest.TestCase):
    ...
    def test_src_files(self):
        for name in ("core/runtime/toggles.py", "code/live_view.py", "editor/text_editor.py",
                     "editor/pending_save.py", "core/rendering/shaped.py"):
            path = SRC / name
