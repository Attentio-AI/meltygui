...
| [color_view.py](../meltygui/view/color_view.py) | `draw_style_policy_fast`, `draw_style_residuals_fast`, `draw_view_offsets_fast`, `draw_view_icon_fast`, `draw_color_picker`, `draw_tint_context` |
