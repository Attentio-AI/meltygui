...
|---|---|
| `views/anywhere.py` | [core/parameter_core.py](../meltygui/core/parameter_core.py) |
| `views/basic_view_utils.py` | [core/cursor_core.py](../meltygui/core/cursor_core.py) |
| `views/blit_offscreen.py` | [core/tile_cache.py](../meltygui/core/tile_cache.py) |
| `views/blit_offscreen_debug_renderers.py` | [core/cache_diagnostics.py](../meltygui/core/cache_diagnostics.py) |
| `views/columns.py` | [core/column_core.py](../meltygui/core/column_core.py) |
| `views/core_meta.py` | [state/annotation_state.py](../meltygui/state/annotation_state.py) |
| `views/core_settings.py` | [core/metadata_core.py](../meltygui/core/metadata_core.py) |
| `views/cst_proxy.py` | [model/code_proxy_model.py](../meltygui/model/code_proxy_model.py) |
| `views/drag_drop.py` | [core/drag_drop_core.py](../meltygui/core/drag_drop_core.py) |
| `views/fa_icons.py` | [model/icon_model.py](../meltygui/model/icon_model.py) |
| `views/fast_dock.py` | [core/dock_core.py](../meltygui/core/dock_core.py) |
| `views/file_watch_debug.py` | [core/file_watch_core.py](../meltygui/core/file_watch_core.py) |
| `views/headers.py` | [core/header_runtime.py](../meltygui/core/header_runtime.py) |
| `views/inspect_utils.py` | [core/inspection_core.py](../meltygui/core/inspection_core.py) |
| `views/line_graph_playground.py` | [core/graph_core.py](../meltygui/core/graph_core.py) |
| `views/menu_bar.py` | [view/menu_view.py](../meltygui/view/menu_view.py) |
| `views/monitor.py` | [core/monitor_core.py](../meltygui/core/monitor_core.py) |
| `views/new_core_view.py` | [core/render_dispatch.py](../meltygui/core/render_dispatch.py) |
| `views/search_glow.py` | [view/search_view.py](../meltygui/view/search_view.py) |
| `views/split_overlay_renderer.py` | [core/overlay_renderer.py](../meltygui/core/overlay_renderer.py) |
| `views/stack_trace_view.py` | [core/trace_core.py](../meltygui/core/trace_core.py) |
| `views/texture_view.py` | [view/texture_view.py](../meltygui/view/texture_view.py) |
| `views/tile_manager.py` | [core/tile_manager_core.py](../meltygui/core/tile_manager_core.py) |
| `views/utils/animator.py` | [state/animation_state.py](../meltygui/state/animation_state.py) |
| `views/utils/grid_dots_shader.py` | [core/grid_core.py](../meltygui/core/grid_core.py) |
| `views/utils/imgui_style_manager_class.py` | [core/style_core.py](../meltygui/core/style_core.py) |
| `views/utils/view_utils.py` | [model/format_model.py](../meltygui/model/format_model.py) |
| `views/view_func_selection.py` | [core/view_selection.py](../meltygui/core/view_selection.py) |
| `widgets/actions_playground.py` | [core/action_core.py](../meltygui/core/action_core.py) |
| `widgets/change_value.py` | [core/value_core.py](../meltygui/core/value_core.py) |
| `widgets/claude_terminals.py` | [core/claude_terminal_core.py](../meltygui/core/claude_terminal_core.py) |
...
| `widgets/file_tree.py` | [core/file_tree_core.py](../meltygui/core/file_tree_core.py) |
| `widgets/import_graph_view.py` | [core/import_graph_core.py](../meltygui/core/import_graph_core.py) |
| `widgets/mcp_query_playground.py` | [core/query_core.py](../meltygui/core/query_core.py) |
...
| `widgets/orchestrator.py` | [core/orchestration_core.py](../meltygui/core/orchestration_core.py) |
| `widgets/region_screenshot.py` | [core/screenshot_core.py](../meltygui/core/screenshot_core.py) |
| `widgets/selectors.py` | [core/selector_core.py](../meltygui/core/selector_core.py) |
| `widgets/space_mouse_playground.py` | [core/input_core.py](../meltygui/core/input_core.py) |
| `widgets/stack_trace_playground.py` | [examples/trace_demo.py](../meltygui/examples/trace_demo.py) |
| `widgets/terminal_playground.py` | [core/terminal_core.py](../meltygui/core/terminal_core.py) |
