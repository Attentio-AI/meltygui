...
def draw_icon_selector_plain(input_value, width=20, height=20, name=None,
    ...
    if want_open:
        ...
        if (_snap > 0 or _nav_hit) and menu_ds is not None:
            from meltygui.views.new_core_view import _dd_rows_at
...
def draw_color3_token(input_value, draw_state=None,
    ...
    from meltygui.views.new_core_view import color_picker_height
    from meltygui.views.new_core_view import color_picker_width
    from meltygui.views.new_core_view import color_picker_top_offset
