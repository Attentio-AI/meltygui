...
from meltygui.events.pynput_backend import GlfwQueueBackend
...
class Melty:
    ...
    def begin_frame(cls):
        ...
        from meltygui.rendering.core_render_helpers import clear_floating_text_cache
    ...
    def end_frame(cls):
        ...
        Melty.imgui_popup_open = is_popup_open
        #
        from meltygui.rendering.core_render import get_melty_state
    ...
    def post_frame(cls, imgui_impl, window):
        ...
        from meltygui.rendering.core_render import apply_drag_and_drop
        apply_drag_and_drop()
        pass
    ...
    def cleanup(cls):
        ...
        try:
            from meltygui.rendering.core_render import run_cleanup_callbacks
