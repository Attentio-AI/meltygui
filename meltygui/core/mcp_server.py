...
from meltygui.core.paths import cache_root
_ROOT = cache_root()
STATE_DIR = _ROOT
...
def start_launcher_mcp(model_server, host=HOST, port=PORT):
    ...
    def status() -> str:
        ...
        studio as a bug.
        """
        import meltygui.core.session_status as session_status
    ...
    def hotswap(path: str, source: str = "") -> str:
        ...
        import meltygui.core.mcp_hotswap as mcp_hotswap
    ...
    def screenshot(window: str):
        ...
        from meltygui.core.screenshot import request_capture
    ...
    def list_windows() -> str:
        ...
        if not model_server._studio_running():
            return "no studio session running — call launch first"
        from meltygui.core.screenshot import list_window_names
    ...
    def eval_python(code: str) -> str:
        ...
        """
        from meltygui.core.mcp_eval import request_eval
    ...
    def _query(collect):
        if not model_server._studio_running():
            return "no studio session running — call launch first"
        from meltygui.core.mcp_query import run_query
    ...
    def find_views(func: str = "", name: str = "", window: str = "",
        ...
        from meltygui.core.mcp_query import collect_find_views
    ...
    def describe_view(view: str, children_depth: int = 1) -> str:
        ...
        from meltygui.core.mcp_query import collect_describe_view
    ...
    def hit_test(x: float, y: float) -> str:
        ...
        from meltygui.core.mcp_query import collect_hit_test
    ...
    def param_sources(view: str, param: str = "") -> str:
        ...
        from meltygui.core.mcp_query import collect_param_sources
    ...
    def tile_cache(view: str = "", history_frames: int = 0, limit: int = 100) -> str:
        ...
        from meltygui.core.mcp_query import collect_tile_cache
