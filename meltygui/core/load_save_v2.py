...
from meltygui.core.dict_conversion_util import ClassUtility
from meltygui.state.core_enums import generate_id
from meltygui.core.missing_saved_class import missing_saved_class
from meltygui.core.missing_saved_class import restore_saved_class
...
def _live_inject_plan(cls):
    ...
    if plan is None:
        plan = []
        try:
            from meltygui.core.core_decoration import auto_eval
        except ImportError:
