...
def boot(app_id=None):
    ...
    import meltygui.core.warm_start as warm_start
    ...
    from meltygui.core.glfw_utils import apply_wayland_frame_hint
...
def _run_imports():
    try:
        ...
        import meltygui.core.surface as surface  # noqa: F401
...
def _init_melty():
    ...
    from meltygui.core.fonts import FontManager
...
def _load_session():
    ...
    if session is None:
        _wait_imports()
        import meltygui.core.app_session as app_session
...
def _present_children(parent):
    ...
    import meltygui.core.wayland_move as wayland_move
    ...
    for child in list(parent.children):
        ...
        if (child_moved and not parent_moved and not req.pinned and not child.await_ack
            ...
            from meltygui.core.window_visibility import native_user_window_position
