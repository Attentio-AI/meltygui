...
import meltygui.core.titlebar_buttons as titlebar_buttons
import meltygui.core.wayland_move as wayland_move
import meltygui.core.hypr_left_drag as hypr_left_drag
...
def backend_supported():
    ...
    if _on_wayland():
        from meltygui.core.glfw_utils import wayland_native_frame_active
...
def _close_blocked_by_merge():
    ...
    try:
        ...
        if not PendingSave.needs_merge():
            return False
        from meltygui.core.extensions import get, call
