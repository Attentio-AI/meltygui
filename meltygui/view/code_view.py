...
def draw_function(input_value, name, draw_state, unique, auto_run=None, wrap=False,
    ...
    from meltygui.view.collection_view import draw_collection
    from meltygui.view.control_view import button
    from meltygui.core.render_dispatch import _RUN_RESULT_HOLDERS
    from meltygui.core.render_dispatch import _format_run_error
    from meltygui.core.render_dispatch import _respond_to_cuda_oom
    from meltygui.core.render_dispatch import draw_any
    from meltygui.core.render_dispatch import is_run_busy
    from meltygui.core.render_dispatch import run_busy_begin
    from meltygui.core.render_dispatch import run_busy_end
